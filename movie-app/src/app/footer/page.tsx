      ...
      <div className="max-w-3/4 m-auto grid grid-cols-1 md:grid-cols-6 gap-8 rounded py-15 px-5 ">
        <div className="col-span-1 md:col-span-2 space-y-2">
          ...
          <div className="flex items-center space-x-2 mb-4">
            <Image src="/images/popCorn.jpg" alt="Moovie" width={32} height={32} className="w-8 h-8"/>
          ...
          <div className="flex space-x-4">
            <a href="#" aria-label="Download on the App Store" className="block">
              <Image src="/images/app store.webp" alt="App Store" width={128} height={40} className="w-32"/></a>
            <a href="#" aria-label="Get it on Google Play" className="block">
              <Image src="/images/google play.webp" alt="Google Play" width={128} height={40} className="w-32"/></a>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex space-x-3 mt-2 text-gray-400">
            <a href="#" aria-label="Facebook" className="hover:text-yellow-500 text-lg"><FaFacebookF /></a>
            <a href="#" aria-label="Instagram" className="hover:text-yellow-500 text-lg"><FaInstagram /></a>
            <a href="#" aria-label="Whatsapp" className="hover:text-yellow-500 text-lg"><BsWhatsapp /></a>
          </div>
        </div>
